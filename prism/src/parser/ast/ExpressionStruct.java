...
public class ExpressionStruct extends Expression
{
	...
	@Override
	public ExpressionStruct deepCopy(DeepCopy copier) throws PrismLangException
	{
		copier.copyAll(fields);
	...
	{
		ExpressionStruct clone = (ExpressionStruct) super.clone();

		clone.fields = (ArrayList<Expression>) fields.clone();
