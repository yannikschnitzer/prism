...
public class DeclarationStruct extends DeclarationType
{
	...
	private ArrayList<DeclarationType> fieldTypes;
	...
	@Override
	public DeclarationStruct deepCopy(DeepCopy copier) throws PrismLangException
	{
		copier.copyAll(fieldTypes);
	...
	@Override
	public DeclarationStruct clone()
	{
		DeclarationStruct clone = (DeclarationStruct) super.clone();

		clone.fieldNames = (ArrayList<String>) fieldNames.clone();
		clone.fieldTypes = (ArrayList<DeclarationType>) fieldTypes.clone();
