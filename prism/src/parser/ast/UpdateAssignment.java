 ...
 */
public class UpdateAssignment extends UpdateNew
{
	...
	/** Constructor */
	public UpdateAssignment(ExpressionIdent v, Expression e)
	{
		var = v.getName();
		expr = e;
	...
	public UpdateAssignment(UpdateAssignment other)
	{
		var = other.var;
		expr = other.expr;
		type = other.type;
	...
	@Override
	public UpdateAssignment deepCopy()
	{
		UpdateAssignment result = new UpdateAssignment((ExpressionIdent)ident.deepCopy(), expr.deepCopy());
		result.type = type;
		result.index = index;
		return result;
	}
