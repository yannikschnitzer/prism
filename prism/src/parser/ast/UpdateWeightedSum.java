 ...
 */
public class UpdateWeightedSum extends UpdateNew
{
	// Pairs of probabilities/updates
	private ArrayList<Expression> probs;
	private ArrayList<UpdateNew> updates;
	// Parent command
	 ...
	 */
	public UpdateWeightedSum()
	{
		probs = new ArrayList<Expression>();
		updates = new ArrayList<UpdateNew>();
		parent = null;
	}
	 ...
	 */
	public void addUpdate(Expression p, UpdateNew u)
	{
		probs.add(p);
		updates.add(u);
//		u.setParent(this);
	 ...
	 * Set the ith update.
	 */
	public void setUpdate(int i, UpdateNew u)
	{
		updates.set(i, u);
//		u.setParent(this);
	}
	 ...
	 * Get the ith update.
	 */
	public UpdateNew getUpdate(int i)
	{
	 ...
	 */
	public List<UpdateNew> getUpdates()
	{
		return updates;
	}
	 ...
	 * Perform a deep copy.
	 */
	public UpdateWeightedSum deepCopy()
	{
		int i, n;
		Expression p;
		UpdateWeightedSum ret = new UpdateWeightedSum();
		n = getNumUpdates();
		for (i = 0; i < n; i++) {
			p = getProbability(i);
			if (p != null)
				p = p.deepCopy();
			ret.addUpdate(p, (UpdateNew) getUpdate(i).deepCopy());
		}
