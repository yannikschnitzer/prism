 ...
 */
public class UpdateAnd extends UpdateNew implements Iterable<UpdateNew>
{
	// Individual elements of update
	private ArrayList<UpdateNew> elements;
	...
	{
		elements.add(new UpdateAssignment(v, e));
	}

	/**
	 * Add a variable assignment (encoded as an UpdateElement) to this update.
	 */
	public void addElement(UpdateNew e)
	{
		elements.add(e);
	}

	/**
	 * Set the ith variable assignment (encoded as an UpdateNew) to this update.
	 */
	public void setElement(int i, UpdateNew e)
	{
		elements.set(i, e);
	}
...
//	}
	...
	public UpdateNew getElement(int index)
	{
...
//	}
	...
	@Override
	public UpdateAnd deepCopy()
	{
		UpdateAnd ret = new UpdateAnd();
		for (UpdateNew e : this) {
	...
	@Override
	public Iterator<UpdateNew> iterator()
	{
	...
	public String toString()
	{
		// Normal case
		if (elements.size() > 0) {
			return elements.stream().map(UpdateNew::toString).collect(Collectors.joining(" & "));
		}
		// Special (empty) case
		else {
			return "true";
