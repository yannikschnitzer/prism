...
public class CVaRProduct extends Product<MDP<Double>>
{
    private int memSize;
    private int invMap[];

    public CVaRProduct(MDP<Double> productModel, MDP<Double> originalModel, int memSize, int[] invMap)
    {
    ...
    /**
     ...
     //	 */
    public static  <M extends Model> CVaRProduct makeProduct(DistributionalBellmanAugmented operator, MDP<Double> model, MDPRewards<Double> mdpRewards, double gamma, BitSet statesOfInterest, PrismLog mainLog) throws PrismException
    {
...
//                mdpProd.addInitialState(mdpProd.getNumStates() -1);
    ...
    /**
     ...
     //	 * @return The product model
     //	 */
    public static  <M extends Model> CVaRProduct makeProduct(double bmin, double bmax, int b_atoms, MDP<Double> model, MDPRewards<Double> mdpRewards, double gamma, BitSet statesOfInterest, PrismLog mainLog) throws PrismException
    {
        ModelType modelType = model.getModelType();
        int mdpNumStates = model.getNumStates();
        int prodNumStates;
