...
public abstract class DistributionalBellmanAugmented {
    ...
    public abstract void initialize(MDP<Double> mdp, MDPRewards<Double> mdpRewards, double gamma, BitSet target) throws PrismException;

    public abstract int getClosestB(double temp_b);

    public abstract void display();

    public abstract void display(MDP<Double> mdp);

    public abstract void display(int s);

    public abstract int[] getStrategy(MDPRewards<Double> mdpRewards, StateRewardsArray rewardsArray, int [] choices, double alpha) throws PrismException;
