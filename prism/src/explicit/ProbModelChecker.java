...
public class ProbModelChecker extends NonProbModelChecker
{
	...
	protected StateValues checkExpressionWeightedMultiObj(Model<?> model, List<Double> weights, List<ExpressionReward> objs, BitSet statesOfInterest) throws PrismException
	{
		...
		List<MDPRewards<Double>> mdpRewardsList = new ArrayList<>();
	 ...
	 * * @param statesOfInterest the states of interest, see checkExpression()
	 */
	protected StateValues checkExpressionWeightedMultiObj(Model<?> model, List<Double> weights, List<MDPRewards<Double>> mdpRewardsList, BitSet target, List<MinMax> minMaxList, BitSet statesOfInterest) throws PrismException
	{
	...
	/**
	 * Model check a Pareto multi-objective property and return the values for the statesOfInterest.
	 * * @param statesOfInterest the states of interest, see checkExpression()
	 */
