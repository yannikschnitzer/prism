...
public class MDPModelCheckerDistributional extends ProbModelChecker
{
	...
	public ModelCheckerResult computeReachRewardsDist(MDP<Double> mdp, MDPRewards<Double> mdpRewards, BitSet target, boolean min) throws PrismException
	{
...
//		timerProb1 = System.currentTimeMillis() - timerProb1;
		...
		if (distr_type.equals(c51) || distr_type.equals(qr)) {
			...
			String [] params = mcMDP.readParams(null);
