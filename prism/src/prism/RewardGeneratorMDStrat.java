 ...
 * to a corresponding model induced by a memoryless/deterministic strategy (e.g. DTMC).
 */
public class RewardGeneratorMDStrat<Value> implements RewardGenerator<Value>
{
	...
	{
		return rewGen.getRewardEvaluator();
	}
