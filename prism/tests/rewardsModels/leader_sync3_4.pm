...
module process1
	...
	// pick value
	[pick] s1=0 & n1 < Rewards -> 1/K : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true) & (n1' = n1 + 1)
	             + 1/K : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true) & (n1' = n1 + 1);
	// read
...
module process2 = process1 [ s1=s2,p1=p2,v1=v2,u1=u2,v2=v3, n1=n2] endmodule
module process3 = process1 [ s1=s3,p1=p3,v1=v3,u1=u3,v2=v1, n1=n3] endmodule
