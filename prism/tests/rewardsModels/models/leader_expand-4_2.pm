...
module process1
	...
	[pick] s1=0 & n1<Rewards -> 1/K : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true) & (n1' = n1+1) + 1/K : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true) & (n1' = n1+1);
...
module process2
	...
	[pick] s2=0 -> 1/K : (s2'=1) & (p2'=0) & (v2'=0) & (u2'=true) + 1/K : (s2'=1) & (p2'=1) & (v2'=1) & (u2'=true);
...
module process3
	...
	[pick] s3=0 -> 1/K : (s3'=1) & (p3'=0) & (v3'=0) & (u3'=true) + 1/K : (s3'=1) & (p3'=1) & (v3'=1) & (u3'=true);
...
module process4
	...
	[pick] s4=0 -> 1/K : (s4'=1) & (p4'=0) & (v4'=0) & (u4'=true) + 1/K : (s4'=1) & (p4'=1) & (v4'=1) & (u4'=true);
