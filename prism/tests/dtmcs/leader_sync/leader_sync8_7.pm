...
const K = 7; // range of probabilistic choice
...
module counter
	...
	[read] c=N-1 -> (c'=c);
	//decide
	[done] u1|u2|u3|u4|u5|u6|u7|u8 -> (c'=c);
	// pick again reset counter 
	[retry] !(u1|u2|u3|u4|u5|u6|u7|u8) -> (c'=1);
...
module process8 = process1 [ s1=s8,p1=p8,v1=v8,u1=u8,v2=v1 ] endmodule
...
// labels
label "elected" = s1=3&s2=3&s3=3&s4=3&s5=3&s6=3&s7=3&s8=3;
