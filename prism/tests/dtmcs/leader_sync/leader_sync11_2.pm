...
// CONSTANTS
const N = 11; // number of processes
...
module counter
	...
	[read] c=N-1 -> (c'=c);
	//decide
	[done] u1|u2|u3|u4|u5|u6|u7|u8|u9|u10|u11 -> (c'=c);
	// pick again reset counter 
	[retry] !(u1|u2|u3|u4|u5|u6|u7|u8|u9|u10|u11) -> (c'=1);
...
module process11 = process1 [ s1=s11,p1=p11,v1=v11,u1=u11,v2=v1 ] endmodule
...
// labels
label "elected" = s1=3&s2=3&s3=3&s4=3&s5=3&s6=3&s7=3&s8=3&s9=3&s10=3&s11=3;
