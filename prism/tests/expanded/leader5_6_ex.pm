...
module process1
	...
	[pick] s1=0 & n1<Rewards -> 1/K : (s1'=1) & (p1'=0) & (v1'=0) & (u1'=true) & (n1' = n1+1) + 1/K : (s1'=1) & (p1'=1) & (v1'=1) & (u1'=true) & (n1' = n1+1) + 1/K : (s1'=1) & (p1'=2) & (v1'=2) & (u1'=true) & (n1' = n1+1) + 1/K : (s1'=1) & (p1'=3) & (v1'=3) & (u1'=true) & (n1' = n1+1) + 1/K : (s1'=1) & (p1'=4) & (n1' = n1+1) & (v1'=4) & (u1'=true) + 1/K : (s1'=1) & (p1'=5) & (v1'=5) & (u1'=true) & (n1' = n1+1);
...
module process5
	...
	[read] s5=1&u5&c<N-1 -> (u5'=(p5!=v1)) & (v5'=v1);
	[read] s5=1&!u5&c<N-1 -> (u5'=false) & (v5'=v1) & (p5'=0);
	[read] s5=1&u5&c=N-1 -> (s5'=2) & (u5'=(p5!=v1)) & (v5'=0) & (p5'=0);
