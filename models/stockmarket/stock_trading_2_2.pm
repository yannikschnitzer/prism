...
rewards
    ...
    [buy1] t1 < T : max(0, (owns1? (2*((rising11?1:0) + (rising12?1:0)) - 2) : 0) + (owns2? (2*((rising21?1:0) + (rising22?1:0)) - 2) : 0));

    [buy2] t1 < T : max(0, (owns1? (2*((rising11?1:0) + (rising12?1:0)) - 2) : 0) + (owns2? (2*((rising21?1:0) + (rising22?1:0)) - 2) : 0));

    [sell1] t1 < T : max(0, (owns1? (2*((rising11?1:0) + (rising12?1:0)) - 2) : 0) + (owns2? (2*((rising21?1:0) + (rising22?1:0)) - 2) : 0));

    [sell2] t1 < T : max(0, (owns1? (2*((rising11?1:0) + (rising12?1:0)) - 2) : 0) + (owns2? (2*((rising21?1:0) + (rising22?1:0)) - 2) : 0));

    [nothing] t1 < T : max(0, (owns1? (2*((rising11?1:0) + (rising12?1:0)) - 2) : 0) + (owns2? (2*((rising21?1:0) + (rising22?1:0)) - 2) : 0));
