...
module sector3
    ...
    [buy1] t1 < T & rising31 = false & rising32 = false & rising33 = false ->
        (1 - P0) * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P0 * P0 * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = owns3) +
        P0 * P0 * P0 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = owns3);

    [buy1] t1 < T & rising31 = true & rising32 = false & rising33 = false ->
        (1 - P1) * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P1 * P1 * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = owns3) +
        P1 * P1 * P1 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = owns3);
    ...
    [buy1] t1 < T & rising31 = true & rising32 = true & rising33 = false ->
        (1 - P2) * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P2 * P2 * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = owns3) +
        P2 * P2 * P2 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = owns3);
    ...
    [buy1] t1 < T & rising31 = true & rising32 = true & rising33 = true ->
        (1 - P3) * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = owns3) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = owns3) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = owns3) +
        P3 * P3 * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = owns3) +
        P3 * P3 * P3 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = owns3);
    ...
    [buy3] t1 < T & rising31 = false & rising32 = false & rising33 = false ->
        (1 - P0) * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P0 * P0 * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = true) +
        P0 * P0 * P0 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = true);

    [buy3] t1 < T & rising31 = true & rising32 = false & rising33 = false ->
        (1 - P1) * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P1 * P1 * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = true) +
        P1 * P1 * P1 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = true);
    ...
    [buy3] t1 < T & rising31 = true & rising32 = true & rising33 = false ->
        (1 - P2) * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P2 * P2 * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = true) +
        P2 * P2 * P2 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = true);
    ...
    [buy3] t1 < T & rising31 = true & rising32 = true & rising33 = true ->
        (1 - P3) * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = true) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = true) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = true) +
        P3 * P3 * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = true) +
        P3 * P3 * P3 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = true);
    ...
    [sell3] t1 < T & rising31 = false & rising32 = false & rising33 = false ->
        (1 - P0) * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P0 * (1 - P0) * (1 - P0) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P0 * P0 * (1 - P0) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P0 * P0 * (1 - P0) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = false) +
        P0 * P0 * P0 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = false);

    [sell3] t1 < T & rising31 = true & rising32 = false & rising33 = false ->
        (1 - P1) * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P1 * (1 - P1) * (1 - P1) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P1 * P1 * (1 - P1) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P1 * P1 * (1 - P1) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = false) +
        P1 * P1 * P1 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = false);
    ...
    [sell3] t1 < T & rising31 = true & rising32 = true & rising33 = false ->
        (1 - P2) * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P2 * (1 - P2) * (1 - P2) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P2 * P2 * (1 - P2) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P2 * P2 * (1 - P2) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = false) +
        P2 * P2 * P2 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = false);
    ...
    [sell3] t1 < T & rising31 = true & rising32 = true & rising33 = true ->
        (1 - P3) * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = false) & (owns3' = false) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = true) & (rising33' = false) & (owns3' = false) +
        P3 * (1 - P3) * (1 - P3) : (rising31' = false) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P3 * P3 * (1 - P3) : (rising31' = true) & (rising32' = false) & (rising33' = true) & (owns3' = false) +
        P3 * P3 * (1 - P3) : (rising31' = false) & (rising32' = true) & (rising33' = true) & (owns3' = false) +
        P3 * P3 * P3 : (rising31' = true) & (rising32' = true) & (rising33' = true) & (owns3' = false);
