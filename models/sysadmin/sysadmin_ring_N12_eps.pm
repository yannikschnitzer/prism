...
module comp_0
    ...
    [repair_0] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_0] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_1] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_1] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_2] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_2] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_3] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_3] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_4] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_4] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_5] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_5] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_6] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_6] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_7] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_7] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_8] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_8] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_9] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_9] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_10] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_10] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_11] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_11] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [noop] s_0=1 & s_11=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [noop] s_0=1 & (s_11=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
...
module comp_1
    ...
    [repair_10] s_1=1 & s_0=1 & s_2=1 & t_0<T -> [p0-eps,p0+eps]:(s_1'=0) + [(1-p0-eps),(1-p0+eps)]:(s_1'=1);
    [repair_10] s_1=1 & (s_0=0 | s_2=0) & t_0<T -> [p1-eps,p1+eps]:(s_1'=0) + [(1-p1-eps),(1-p1+eps)]:(s_1'=1);
    [repair_11] s_1=1 & s_0=1 & s_2=1 & t_0<T -> [p0-eps,p0+eps]:(s_1'=0) + [(1-p0-eps),(1-p0+eps)]:(s_1'=1);
    [repair_11] s_1=1 & (s_0=0 | s_2=0) & t_0<T -> [p1-eps,p1+eps]:(s_1'=0) + [(1-p1-eps),(1-p1+eps)]:(s_1'=1);
...
module comp_2
    ...
    [repair_10] s_2=1 & s_1=1 & s_3=1 & t_0<T -> [p0-eps,p0+eps]:(s_2'=0) + [(1-p0-eps),(1-p0+eps)]:(s_2'=1);
    [repair_10] s_2=1 & (s_1=0 | s_3=0) & t_0<T -> [p1-eps,p1+eps]:(s_2'=0) + [(1-p1-eps),(1-p1+eps)]:(s_2'=1);
    [repair_11] s_2=1 & s_1=1 & s_3=1 & t_0<T -> [p0-eps,p0+eps]:(s_2'=0) + [(1-p0-eps),(1-p0+eps)]:(s_2'=1);
    [repair_11] s_2=1 & (s_1=0 | s_3=0) & t_0<T -> [p1-eps,p1+eps]:(s_2'=0) + [(1-p1-eps),(1-p1+eps)]:(s_2'=1);
...
module comp_3
    ...
    [repair_10] s_3=1 & s_2=1 & s_4=1 & t_0<T -> [p0-eps,p0+eps]:(s_3'=0) + [(1-p0-eps),(1-p0+eps)]:(s_3'=1);
    [repair_10] s_3=1 & (s_2=0 | s_4=0) & t_0<T -> [p1-eps,p1+eps]:(s_3'=0) + [(1-p1-eps),(1-p1+eps)]:(s_3'=1);
    [repair_11] s_3=1 & s_2=1 & s_4=1 & t_0<T -> [p0-eps,p0+eps]:(s_3'=0) + [(1-p0-eps),(1-p0+eps)]:(s_3'=1);
    [repair_11] s_3=1 & (s_2=0 | s_4=0) & t_0<T -> [p1-eps,p1+eps]:(s_3'=0) + [(1-p1-eps),(1-p1+eps)]:(s_3'=1);
...
module comp_4
    ...
    [repair_10] s_4=1 & s_3=1 & s_5=1 & t_0<T -> [p0-eps,p0+eps]:(s_4'=0) + [(1-p0-eps),(1-p0+eps)]:(s_4'=1);
    [repair_10] s_4=1 & (s_3=0 | s_5=0) & t_0<T -> [p1-eps,p1+eps]:(s_4'=0) + [(1-p1-eps),(1-p1+eps)]:(s_4'=1);
    [repair_11] s_4=1 & s_3=1 & s_5=1 & t_0<T -> [p0-eps,p0+eps]:(s_4'=0) + [(1-p0-eps),(1-p0+eps)]:(s_4'=1);
    [repair_11] s_4=1 & (s_3=0 | s_5=0) & t_0<T -> [p1-eps,p1+eps]:(s_4'=0) + [(1-p1-eps),(1-p1+eps)]:(s_4'=1);
...
module comp_5
    ...
    [repair_10] s_5=1 & s_4=1 & s_6=1 & t_0<T -> [p0-eps,p0+eps]:(s_5'=0) + [(1-p0-eps),(1-p0+eps)]:(s_5'=1);
    [repair_10] s_5=1 & (s_4=0 | s_6=0) & t_0<T -> [p1-eps,p1+eps]:(s_5'=0) + [(1-p1-eps),(1-p1+eps)]:(s_5'=1);
    [repair_11] s_5=1 & s_4=1 & s_6=1 & t_0<T -> [p0-eps,p0+eps]:(s_5'=0) + [(1-p0-eps),(1-p0+eps)]:(s_5'=1);
    [repair_11] s_5=1 & (s_4=0 | s_6=0) & t_0<T -> [p1-eps,p1+eps]:(s_5'=0) + [(1-p1-eps),(1-p1+eps)]:(s_5'=1);
...
module comp_6
    ...
    [repair_10] s_6=1 & s_5=1 & s_7=1 & t_0<T -> [p0-eps,p0+eps]:(s_6'=0) + [(1-p0-eps),(1-p0+eps)]:(s_6'=1);
    [repair_10] s_6=1 & (s_5=0 | s_7=0) & t_0<T -> [p1-eps,p1+eps]:(s_6'=0) + [(1-p1-eps),(1-p1+eps)]:(s_6'=1);
    [repair_11] s_6=1 & s_5=1 & s_7=1 & t_0<T -> [p0-eps,p0+eps]:(s_6'=0) + [(1-p0-eps),(1-p0+eps)]:(s_6'=1);
    [repair_11] s_6=1 & (s_5=0 | s_7=0) & t_0<T -> [p1-eps,p1+eps]:(s_6'=0) + [(1-p1-eps),(1-p1+eps)]:(s_6'=1);
...
module comp_7
    ...
    [repair_10] s_7=1 & s_6=1 & s_8=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_10] s_7=1 & (s_6=0 | s_8=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_11] s_7=1 & s_6=1 & s_8=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_11] s_7=1 & (s_6=0 | s_8=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
...
module comp_8
    ...
    [repair_10] s_8=1 & s_7=1 & s_9=1 & t_0<T -> [p0-eps,p0+eps]:(s_8'=0) + [(1-p0-eps),(1-p0+eps)]:(s_8'=1);
    [repair_10] s_8=1 & (s_7=0 | s_9=0) & t_0<T -> [p1-eps,p1+eps]:(s_8'=0) + [(1-p1-eps),(1-p1+eps)]:(s_8'=1);
    [repair_11] s_8=1 & s_7=1 & s_9=1 & t_0<T -> [p0-eps,p0+eps]:(s_8'=0) + [(1-p0-eps),(1-p0+eps)]:(s_8'=1);
    [repair_11] s_8=1 & (s_7=0 | s_9=0) & t_0<T -> [p1-eps,p1+eps]:(s_8'=0) + [(1-p1-eps),(1-p1+eps)]:(s_8'=1);
...
module comp_9
    ...
    [repair_0] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_0] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_1] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_1] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_2] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_2] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_3] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_3] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_4] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_4] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_5] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_5] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_6] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_6] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_7] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_7] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_8] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_8] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_9] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_9] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_10] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_10] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [repair_11] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [repair_11] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
    [noop] s_9=1 & s_8=1 & s_10=1 & t_0<T -> [p0-eps,p0+eps]:(s_9'=0) + [(1-p0-eps),(1-p0+eps)]:(s_9'=1);
    [noop] s_9=1 & (s_8=0 | s_10=0) & t_0<T -> [p1-eps,p1+eps]:(s_9'=0) + [(1-p1-eps),(1-p1+eps)]:(s_9'=1);
...
module comp_10
    ...
    [repair_0] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_0] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_1] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_1] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_2] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_2] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_3] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_3] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_4] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_4] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_5] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_5] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_6] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_6] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_7] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_7] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_8] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_8] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_9] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_9] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_10] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_10] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [repair_11] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [repair_11] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
    [noop] s_10=1 & s_9=1 & s_11=1 & t_0<T -> [p0-eps,p0+eps]:(s_10'=0) + [(1-p0-eps),(1-p0+eps)]:(s_10'=1);
    [noop] s_10=1 & (s_9=0 | s_11=0) & t_0<T -> [p1-eps,p1+eps]:(s_10'=0) + [(1-p1-eps),(1-p1+eps)]:(s_10'=1);
...
module comp_11
    ...
    [repair_0] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_0] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_1] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_1] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_2] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_2] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_3] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_3] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_4] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_4] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_5] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_5] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_6] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_6] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_7] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_7] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_8] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_8] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_9] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_9] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_10] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_10] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [repair_11] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [repair_11] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
    [noop] s_11=1 & s_10=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_11'=0) + [(1-p0-eps),(1-p0+eps)]:(s_11'=1);
    [noop] s_11=1 & (s_10=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_11'=0) + [(1-p1-eps),(1-p1+eps)]:(s_11'=1);
