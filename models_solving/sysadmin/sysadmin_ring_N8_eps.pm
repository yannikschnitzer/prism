// Auto‐generated SysAdmin (N=8 bidirectional ring, T=10)
mdp
...
module comp_0
    ...
    [repair_0] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_0] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_1] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_1] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_2] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_2] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_3] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_3] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_4] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_4] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_5] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_5] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_6] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_6] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_7] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [repair_7] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [noop] s_0=1 & s_7=1 & s_1=1 & t_0<T -> [p0-eps,p0+eps]:(s_0'=0) + [(1-p0-eps),(1-p0+eps)]:(s_0'=1) & (t_0'=t_0+1);
    [noop] s_0=1 & (s_7=0 | s_1=0) & t_0<T -> [p1-eps,p1+eps]:(s_0'=0) + [(1-p1-eps),(1-p1+eps)]:(s_0'=1) & (t_0'=t_0+1);
...
module comp_7
    ...
    [repair_0] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_0] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_1] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_1] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_2] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_2] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_3] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_3] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_4] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_4] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_5] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_5] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_6] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_6] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [repair_7] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [repair_7] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
    [noop] s_7=1 & s_6=1 & s_0=1 & t_0<T -> [p0-eps,p0+eps]:(s_7'=0) + [(1-p0-eps),(1-p0+eps)]:(s_7'=1);
    [noop] s_7=1 & (s_6=0 | s_0=0) & t_0<T -> [p1-eps,p1+eps]:(s_7'=0) + [(1-p1-eps),(1-p1+eps)]:(s_7'=1);
