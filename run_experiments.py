...
config = {
    ...
    'betting_g_gran' :{'model':prefix+'tests/betting_game/betting_game_gran.prism', 'props':prefix+'tests/betting_game/betting_game.props', 'dir':'betting_game/', 'pn':[3,2,-1,1,4,5], 'vmax': def_vmax, 'atoms':201, 'epsilon':def_eps, 'b':101, 'alpha':0.8, 'u_atoms':11, 'u_bounds':[0.0, 1.0], 'params':['p']},
